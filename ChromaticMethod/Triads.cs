...
namespace ChromaticMethod
{
    public class Triads
    {
        ...
        public static string TriadI(string Key)
        {
            if (Key == "C")
            {
                var I = C[0];
        ...
        public static string TriadII(string Key)
        {
            if (Key == "C")
            {
                var I = C[0];
        ...
        public static string TriadIII(string Key)
        {
            if (Key == "C")
            {
                var I = C[0];
        ...
        public static string TriadIV(string Key)
        {
            if (Key == "C")
            {
                var I = C[0];
        ...
        public static string TriadV(string Key)
        {
            if (Key == "C")
            {
                var I = C[0];
        ...
        public static string TriadVI(string Key)
        {
            if (Key == "C")
            {
                var I = C[0];
        ...
        public static string TriadVII(string Key)
        {
            if (Key == "C")
            {
                var I = C[0];
