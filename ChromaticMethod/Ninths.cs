...
namespace ChromaticMethod
{
    public class Ninths
    {
        ...
        public static string NinthI(string Key)
        {
            if (Key == "C")
            {
                var I = C[0];
        ...
        public static string NinthII(string Key)
        {
            if (Key == "C")
            {
                var I = C[0];
        ...
        public static string NinthIII(string Key)
        {
            if (Key == "C")
            {
                var I = C[0];
        ...
        public static string NinthIV(string Key)
        {
            if (Key == "C")
            {
                var I = C[0];
        ...
        public static string NinthV(string Key)
        {
            if (Key == "C")
            {
                var I = C[0];
        ...
        public static string NinthVI(string Key)
        {
            if (Key == "C")
            {
                var I = C[0];
        ...
        public static string NinthVII(string Key)
        {
            if (Key == "C")
            {
                var I = C[0];
